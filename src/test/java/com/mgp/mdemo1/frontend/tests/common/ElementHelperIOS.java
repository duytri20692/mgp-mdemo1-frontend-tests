...
public class ElementHelperIOS {
    protected IOSDriver driver;

    public ElementHelperIOS(IOSDriver driver){
        this.driver = driver;
        PageFactory.initElements(driver,this);
    }

    public boolean waitForPresence(IOSDriver driver, int timeLimitInSeconds, WebElement webElement) {
        try{
